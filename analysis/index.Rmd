...
data](https://www.divvybikes.com/system-data). I also analyze the data
from a Divvy bike station at the University of Chicago to compare the
...
other pages/notebooks:
    ...
    - [Time-of-day trends](time-of-day-trends.html).
    - [Seasonal trends](seasonal-trends.html).
